  ...
  async initialize() {
    ...
    try {
      ...
      if (storedData) {
        ...
        if (data.approvalSequences) this.approvalSequences = new Map(Object.entries(data.approvalSequences));
    ...
    this.saveTimeout = setTimeout(() => {
      try {
        const data = {
          ...
          approvalSequences: Object.fromEntries(this.approvalSequences),
